...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
unsigned char const AsciiCode16x8[1520] = 
{
/*  阴码 顺向 逐行式 */
...
const GB2312Type16x16 GB2312Code16x16[]=
{
/*  阴码 顺向 逐行式 */  
"时",
...
"间",
0x13,0xFC,0x10,0x04,0x40,0x04,0x47,0xC4,0x44,0x44,0x44,0x44,0x44,0x44,0x47,0xC4,
0x44,0x44,0x44,0x44,0x44,0x44,0x47,0xC4,0x40,0x04,0x40,0x14,0x40,0x08,0x00,0x00,/*"间",1*/
"日",
0x1F,0xF0,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x1F,0xF0,0x10,0x10,
0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x1F,0xF0,0x10,0x10,0x00,0x00,/*"日",2*/
"星",
0x00,0x00,0x1F,0xF0,0x10,0x10,0x1F,0xF0,0x10,0x10,0x1F,0xF0,0x01,0x00,0x11,0x00,
0x1F,0xF8,0x21,0x00,0x41,0x00,0x1F,0xF0,0x01,0x00,0x01,0x00,0x7F,0xFC,0x00,0x00,/*"星",3*/
"期",
0x22,0x7C,0x7F,0x44,0x22,0x44,0x22,0x44,0x3E,0x7C,0x22,0x44,0x22,0x44,0x3E,0x44,
0x22,0x7C,0x22,0x44,0xFF,0x44,0x04,0x84,0x22,0x84,0x41,0x14,0x82,0x08,0x00,0x00,/*"期",4*/ 
"分",  
0x00,0x00,0x00,0x40,0x04,0x20,0x04,0x20,0x08,0x10,0x08,0x08,0x10,0x04,0x7F,0xFA,
0x02,0x09,0x02,0x08,0x02,0x08,0x04,0x08,0x04,0x08,0x08,0x08,0x10,0x08,0x60,0xF0,/*"分",5*/
"数",
0x00,0x00,0x00,0x00,0x25,0x20,0x25,0x20,0x26,0x3E,0x7F,0xA4,0x0E,0x64,0x35,0x64,
0x44,0x24,0x08,0x24,0x7F,0x18,0x11,0x18,0x21,0x18,0x1A,0x14,0x06,0x24,0x79,0xC2,/*"数",6*/
};
...
/*******************************************************************************
  ...
  * @retval None
****************************************************************Author:Liming**/
//void LCD_DisGB16x16(u8 col, u8 page, u8 *s)
//{
//	uint16_t Num;
//	uint8_t i,m,l = 0;
//    l = col;
//    while(*s)
//    {
//        for(Num = 0; Num < sizeof(GB2312Code16x16)/35; Num++)              // 搜索字库表找到相应的字库
//        {
//            if((GB2312Code16x16[Num].Head[0] == *s) && (GB2312Code16x16[Num].Head[1] == *(s+1)))
//            {     
//                m = 0;
//                LCD_CmdWrite(0xB0|Comtab[page&0x07]);            //page
//                LCD_CmdWrite((l>>4) | 0x10);                 //set col hight
//                LCD_CmdWrite(l&0x0f);
//                for(i=0;i<16;i++)
//                {
//                 LCD_DataWrite(GB2312Code16x16[Num].Infor[m]);
//                 m++;
//                }
//                page++;
//                LCD_CmdWrite(0xB0|Comtab[page&0x07]);            //page
